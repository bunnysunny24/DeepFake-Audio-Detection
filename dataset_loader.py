...
class MultiModalDeepfakeDataset(Dataset):
    ...
    def _count_classes(self):
        ...
        Since we're using contrastive learning with pairs, each sample in valid_indices
        produces TWO training examples: 1 fake video + 1 original (real) video.
        
        IMPORTANT: Multiple fake videos may reference the same original video!
        We count UNIQUE original videos to get the true real sample count.
        """
