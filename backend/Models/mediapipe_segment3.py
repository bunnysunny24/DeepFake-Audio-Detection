...
# Initialize Mediapipe Face Mesh with GPU acceleration
...
def process_train_fake(input_dir, output_dir):
    os.makedirs(output_dir, exist_ok=True)
    image_folder = os.path.join(input_dir, "train", "fake")
...
if __name__ == "__main__":
    ...
    process_train_fake(input_dir, output_dir)
